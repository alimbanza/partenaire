                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body" id="modal_user">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-9">
                                    <input type="text" maxlength="15" onInput={this.props.telephone} value={this.props.telephone_v} className="form-control telephone" />
                                </div>
                            </div>
                            <br/>
                            <div className="row">
        ...
        return (
            <div className="col-12" style={divStyle}>
                <div className="card form-card" style={stylefrom}>
                    <hr/>  
                    <div className="card-body">
                        <Msg bol={ (this.state.state_msg=='r') ? <Msg_reussite msg_reu="Membre enregistré avec succès." /> : (this.state.state_msg=='e') ? <Msg_erreur msg_err={this.state.erreur}/> : ''} />
